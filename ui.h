...
constexpr float columnItemEnlargedSize = std::min((SCREEN_HEIGHT - columnCenterYFirst) * 2,
                                                  std::min(columnItemSize * 1.2f, (SCREEN_WIDTH - columnCenterX) * 2));
...
constexpr SDL_FRect pkgLargeFRect = {columnXEnlarged, columnCenterYFirst - columnItemEnlargedSize * 0.5f,
                                     columnItemEnlargedSize, columnItemEnlargedSize};
...
constexpr SDL_FRect sinkLargeFRect = {columnXEnlarged,
                                      columnSecondItemY + columnItemSize * 0.5f - columnItemEnlargedSize * 0.5f,
                                      columnItemEnlargedSize, columnItemEnlargedSize};
...
constexpr SDL_Rect binRect        = {static_cast<int>(columnX), static_cast<int>(columnThirdItemY),
                                     static_cast<int>(columnItemSize), static_cast<int>(columnItemSize)};
constexpr SDL_FRect binLargeFRect = {columnXEnlarged,
                                     columnThirdItemY + columnItemSize * 0.5f - columnItemEnlargedSize * 0.5f,
                                     columnItemEnlargedSize, columnItemEnlargedSize};
...
constexpr SDL_Rect bowlsRect        = {static_cast<int>(columnX), static_cast<int>(columnFourthItemY),
                                       static_cast<int>(columnItemSize), static_cast<int>(columnItemSize)};
constexpr SDL_FRect bowlsLargeFRect = {columnXEnlarged,
                                       columnFourthItemY + columnItemSize * 0.5f - columnItemEnlargedSize * 0.5f,
                                       columnItemEnlargedSize, columnItemEnlargedSize};
...
constexpr SDL_Rect potToolRect        = {static_cast<int>(columnX), static_cast<int>(columnFifthItemY),
                                         static_cast<int>(columnItemSize), static_cast<int>(columnItemSize)};
constexpr SDL_FRect potToolLargeFRect = {columnXEnlarged,
                                         columnFifthItemY + columnItemSize * 0.5f - columnItemEnlargedSize * 0.5f,
                                         columnItemEnlargedSize, columnItemEnlargedSize};
