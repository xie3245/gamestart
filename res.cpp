...
static const Image images[] = {Image{bgPath},
                               ...
                               Image{"assets/sinks.png"},
                               Image{"assets/ramen_classic.png"},
                               Image{"assets/ramen_beef.png"},
                               Image{"assets/ramen_seafood.png"},
                               Image{"assets/ramen_spicy.png"},
                               ...
                               Image{"assets/post-it.png"},
                               Image{"assets/fridge.png"},
                               Image{"assets/softdrink_kola.png"},
                               Image{"assets/softdrink_funta.png"},
                               Image{"assets/softdrink_peppy.png"},
                               Image{"assets/softdrink_spryte.png"},
